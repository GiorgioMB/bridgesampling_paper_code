...
write_stan_file(sc, dir = getwd(), basename = "eight_schools.stan")
model_cmdstanr <- cmdstan_model("eight_schools.stan", force_recompile = TRUE)
...
write.csv(results, file = "eight_schools_pathfinder.csv", row.names = FALSE)
...
write.csv(results, file = "eight_schools_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results, file = "eight_schools_pathfinder_smoothed.csv", row.names = FALSE)
...
write.csv(results, file = "eight_schools_pathfinder_smoothed_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "eight_schools_pathfinder_bruteforce.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "eight_schools_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "eight_schools_pathfinder_bruteforce_smoothed.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "eight_schools_pathfinder_bruteforce_smoothed_no_cov.csv", row.names = FALSE)
