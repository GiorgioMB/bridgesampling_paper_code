...
model_cmdstanr <- cmdstan_model("dogs_log.stan", force_recompile = TRUE)
...
write.csv(results, file = "dogs_log_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results, file = "dogs_log_pathfinder_smoothed_no_cov.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "dogs_log_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "dogs_log_pathfinder_bruteforce_smoothed_no_cov.csv", row.names = FALSE)
