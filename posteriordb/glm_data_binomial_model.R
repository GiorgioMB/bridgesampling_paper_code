...
set.seed(123)
pd <- pdb_github()
po <- posterior("GLM_Binomial_data-GLM_Binomial_model", pdb = pd)
sc <- stan_code(po)
data <- get_data(po)
model <- stan_model(model_code = sc)
write_stan_file(sc, dir = getwd(), basename = "GLM_Binomial_data-GLM_Binomial_model.stan")
model_cmdstanr <- cmdstan_model("GLM_Binomial_data-GLM_Binomial_model.stan", force_recompile = TRUE)
...
write.csv(results, file = "glm_data_binomial_model_pathfinder.csv", row.names = FALSE)
...
write.csv(results, file = "glm_data_binomial_model_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results, file = "glm_data_binomial_model_pathfinder_smoothed.csv", row.names = FALSE)
...
write.csv(results, file = "glm_data_binomial_model_pathfinder_smoothed_no_cov.csv", row.names = FALSE)
  ...
  repeat {
    try_res <- tryCatch({
      model_cmdstanr <- cmdstan_model(
        "GLM_Binomial_data-GLM_Binomial_model.stan",
...
write.csv(results_bruteforce, file = "glm_data_binomial_model_pathfinder_bruteforce.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "glm_data_binomial_model_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "glm_data_binomial_model_pathfinder_bruteforce_smoothed.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "glm_data_binomial_model_pathfinder_bruteforce_smoothed_no_cov.csv", row.names = FALSE)
