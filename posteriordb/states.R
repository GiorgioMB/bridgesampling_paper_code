...
set.seed(123)
pd <- pdb_github()
po <- posterior("state_wide_presidential_votes-hierarchical_gp", pdb = pd)
sc <- stan_code(po)
data <- get_data(po)
model <- stan_model(model_code = sc)
write_stan_file(sc, dir = getwd(), basename = "state_wide_presidential_votes-hierarchical_gp.stan")
model_cmdstanr <- cmdstan_model("state_wide_presidential_votes-hierarchical_gp.stan", force_recompile = TRUE)
...
write.csv(results, file = "states_presidential_pathfinder.csv", row.names = FALSE)
...
write.csv(results, file = "states_presidential_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results, file = "states_presidential_pathfinder_smoothed.csv", row.names = FALSE)
...
write.csv(results, file = "states_presidential_pathfinder_smoothed_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "states_presidentials_pathfinder_bruteforce.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "states_presidential_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "states_presidential_pathfinder_bruteforce_smoothed.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "states_presidential_pathfinder_bruteforce_smoothed_no_cov.csv", row.names = FALSE)
