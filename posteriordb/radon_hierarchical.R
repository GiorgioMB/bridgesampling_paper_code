...
set.seed(123)
pd <- pdb_github()
po <- posterior("radon_all-radon_hierarchical_intercept_noncentered", pdb = pd)
sc <- stan_code(po)
data <- get_data(po)
model <- stan_model(model_code = sc)
write_stan_file(sc, dir = getwd(), basename = "radon_all-radon_hierarchical_intercept_noncentered.stan")
model_cmdstanr <- cmdstan_model("radon_all-radon_hierarchical_intercept_noncentered.stan", force_recompile = TRUE)
...
write.csv(results, file = "radon_hierarchical_pathfinder.csv", row.names = FALSE)
...
write.csv(results, file = "radon_hierarchical_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results, file = "radon_hierarchical_pathfinder_smoothed.csv", row.names = FALSE)
...
write.csv(results, file = "radon_hierarchical_pathfinder_smoothed_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_hierarchical_pathfinder_bruteforce.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_hierarchical_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_hierarchical_pathfinder_bruteforce_smoothed.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_hierarchical_pathfinder_bruteforce_smoothed_no_cov.csv", row.names = FALSE)
