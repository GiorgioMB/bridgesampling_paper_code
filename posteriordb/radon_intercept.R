...
set.seed(123)
pd <- pdb_github()
po <- posterior("radon_all-radon_variable_intercept_slope_noncentered", pdb = pd)
sc <- stan_code(po)
data <- get_data(po)
model <- stan_model(model_code = sc)
write_stan_file(sc, dir = getwd(), basename = "radon_all-radon_variable_intercept_slope_noncentered.stan")
model_cmdstanr <- cmdstan_model("radon_all-radon_variable_intercept_slope_noncentered.stan", force_recompile = TRUE)
...
write.csv(results, file = "radon_intercept_pathfinder.csv", row.names = FALSE)
...
write.csv(results, file = "radon_intercept_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results, file = "radon_intercept_pathfinder_smoothed.csv", row.names = FALSE)
...
write.csv(results, file = "radon_intercept_pathfinder_smoothed_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_intercept_pathfinder_bruteforce.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_intercept_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_intercept_pathfinder_bruteforce_smoothed.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "radon_intercept_pathfinder_bruteforce_smoothed_no_cov.csv", row.names = FALSE)
