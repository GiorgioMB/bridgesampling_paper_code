...
data <- get_data(po)
model_cmdstanr <- cmdstan_model("hudson_lynx_hare.stan", force_recompile = TRUE)
...
write.csv(results, file = "hudson_lynx_hare_pathfinder.csv", row.names = FALSE)
...
write.csv(results, file = "hudson_lynx_hare_pathfinder_no_cov.csv", row.names = FALSE)
...
write.csv(results_bruteforce, file = "hudson_lynx_hare_pathfinder_bruteforce.csv", row.names = FALSE)
...
pareto_k_deni_20_brute <- extract_khat(deni, n_draws = 20)[[1]]
results_bruteforce <- cbind(results_bruteforce, pareto_k_numi_10_brute, pareto_k_deni_10_brute, pareto_k_numi_20_brute, pareto_k_deni_20_brute)
write.csv(results_bruteforce, file = "hudson_lynx_hare_pathfinder_bruteforce_no_cov.csv", row.names = FALSE)
